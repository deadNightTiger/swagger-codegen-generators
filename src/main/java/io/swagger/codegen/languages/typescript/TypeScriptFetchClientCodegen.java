...
public class TypeScriptFetchClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public void processOpts() {
        ...
        if (StringUtils.isNotBlank(templateVersion)) {
            embeddedTemplateDir = templateDir = String.format("%s/TypeScriptFetch", templateVersion);
        } else {
            embeddedTemplateDir = templateDir = String.format("%s/TypeScriptFetch", DEFAULT_TEMPLATE_VERSION);
        }
